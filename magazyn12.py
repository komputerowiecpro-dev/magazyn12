...
# Zakładając, że klasa InventoryManager jest zdefiniowana w tej samej sesji Colab lub w osobnym pliku
# Jeśli InventoryManager znajduje się w osobnym pliku inventory_manager.py, upewnij się, że ten plik jest dostępny
